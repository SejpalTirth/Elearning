...
{
    public class CourseIdRequestDtoValidatorTests
    {
        private readonly IFixture _fixture;
        private readonly CourseIdRequestDtoValidator _validator;

        public CourseIdRequestDtoValidatorTests()
        {
            _fixture = new Fixture();
            _validator = new CourseIdRequestDtoValidator();
        }
        ...
        {
            // Arrange
            var dto = _fixture.Build<CourseIdRequestDto>()
