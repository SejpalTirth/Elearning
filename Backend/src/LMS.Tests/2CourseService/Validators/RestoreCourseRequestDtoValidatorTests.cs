...
{
    public class RestoreCourseRequestDtoValidatorTests
    {
        private readonly IFixture _fixture;
        private readonly RestoreCourseRequestDtoValidator _validator;

        public RestoreCourseRequestDtoValidatorTests()
        {
            _fixture = new Fixture();
            _validator = new RestoreCourseRequestDtoValidator();
        }
        ...
        {
            // Arrange
            var dto = _fixture.Build<RestoreCourseRequestDto>()
