...
{
    public class EnrollRequestDtoValidatorTests
    {
        private readonly IFixture _fixture;
        private readonly EnrollRequestDtoValidator _validator;

        public EnrollRequestDtoValidatorTests()
        {
            _fixture = new Fixture();
            _validator = new EnrollRequestDtoValidator();
        }
        ...
        {
            // Arrange
            var dto = _fixture.Build<EnrollRequestDto>()
