...
{
    public class GetUnquizzedModulesDtoValidatorTests
    {
        private readonly IFixture _fixture;
        private readonly GetUnquizzedModulesDtoValidator _validator;

        public GetUnquizzedModulesDtoValidatorTests()
        {
            _fixture = new Fixture();
            _validator = new GetUnquizzedModulesDtoValidator();
        }
        ...
        {
            var dto = _fixture.Build<GetUnquizzedModulesDto>()
